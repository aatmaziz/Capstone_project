...
import com.ahmedaziz.coofde.beans.Backdrop;
...
public class OfferDetailsActivity extends AppCompatActivity {
    ...
    private Cursor checkFavourite(String coofdeId) {
        ...
        if (coofdeId != null && !coofdeId.isEmpty()) {
            String[] projection = {ColumnsDB.COOFDE_ID};
            String selectionClause = ColumnsDB.COOFDE_ID + "=?";
            String[] selectionArgs = {coofdeId};
            String sortOrder = "_id ASC";
            c = this.getContentResolver().query(Provider.Coofde.CONTENT_URI, projection,
    ...
    private int deleteCoofde() {
        ...
        int rows = this.getContentResolver().delete(Provider.Coofde.CONTENT_URI,
    ...
    private void insertCoofde() {
        ...
        contentValues.put(ColumnsDB.COOFDE_ID, mListId);
        contentValues.put(ColumnsDB.CODE, mOfferBean.getCode());
        contentValues.put(ColumnsDB.COUPON, mOfferBean.getCoupon());
        contentValues.put(ColumnsDB.DESC, mOfferBean.getDesc());
        contentValues.put(ColumnsDB.TITLE, mOfferBean.getTitle());
        contentValues.put(ColumnsDB.TYPE, mOfferBean.getType());
        contentValues.put(ColumnsDB.VIEWS, mOfferBean.getViews());
        contentValues.put(ColumnsDB.URL, mOfferBean.getUrl());
        contentValues.put(ColumnsDB.STORE, mStore);

        this.getContentResolver().insert(Provider.Coofde.CONTENT_URI, contentValues);
